...
namespace Core.Implementation
{
    public readonly struct GenericValueLanguage
    {
        ...
        public static bool operator ==(GenericValueLanguage left, GenericValueLanguage right) => left.Equals(right);

        public static bool operator !=(GenericValueLanguage left, GenericValueLanguage right) => !(left == right);
