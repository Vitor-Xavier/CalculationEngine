...
public partial class LanguageParser : Parser {
	...
	public Rule_blockContext rule_block() {
		...
		try {
			...
			case 1:
				EnterOuterAlt(_localctx, 1);
				{
				State = 65; variable_declaration();
				}
				break;
			case 2:
				EnterOuterAlt(_localctx, 2);
				{
				State = 66; switch_expression();
				}
				break;
			case 3:
	...
	public AssignmentContext assignment() {
		...
		try {
			...
			case 1:
				...
				State = 101; Match(ATRIB);
				State = 102; comparison_expression();
			...
			case 2:
				...
				State = 106; assignment_operator();
				State = 107; arithmetic_expression(0);
			...
			case 3:
				...
				State = 119; assignment_operator();
				State = 120; arithmetic_expression(0);
			...
			case 4:
				...
				EnterOuterAlt(_localctx, 4);
				{
				State = 123; Match(VAR_PRIMARY);
				State = 124; Match(DOT);
				State = 125; Match(IDENTIFIER);
				State = 126; assignment_operator();
				State = 127; arithmetic_expression(0);
			...
			case 5:
				...
				case NUMBER:
					{
					State = 133; number_integer();
					}
					break;
				default:
					throw new NoViableAltException(this);
				}
				State = 136; Match(RBRACKET);
				State = 137; Match(DOT);
				State = 138; Match(IDENTIFIER);
				State = 139; assignment_operator();
				State = 140; arithmetic_expression(0);
	...
	public ConditionalContext conditional() {
		...
		try {
			...
			{
			State = 166; Match(IF);
			State = 167; if_expression(0);
			State = 168; Match(LBRACE);
			State = 169; then_block();
	...
	private If_expressionContext if_expression(int _p) {
		...
		try {
			...
			case 1:
				...
				State = 191; comparison_expression();
				}
				break;
			case 2:
				{
			...
			case 3:
				...
				Context = _localctx;
				_prevctx = _localctx;
				State = 197; Match(LPAREN);
				State = 198; if_expression(0);
	...
	public Switch_expressionContext switch_expression() {
		...
		try {
			...
			EnterOuterAlt(_localctx, 1);
			{
			State = 217; Match(SWITCH);
			State = 218; arithmetic_expression(0);
			...
			if (_la==DEFAULT) {
				{
				State = 225; default_statement();
				}
			}

			State = 228; Match(RBRACE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Case_statementContext case_statement() {
		...
		try {
			...
			EnterOuterAlt(_localctx, 1);
			{
			State = 230; Match(CASE);
			State = 231; arithmetic_expression(0);
	...
	public Comparison_expressionContext comparison_expression() {
		...
		try {
			...
			case 1:
				...
				EnterOuterAlt(_localctx, 1);
				{
				State = 257; arithmetic_expression(0);
				State = 258; comparison_operator();
				State = 259; arithmetic_expression(0);
				}
				break;
			case 2:
				...
				State = 262; comparison_expression();
	...
	public LoopContext loop() {
		...
		try {
			...
			EnterOuterAlt(_localctx, 1);
			{
			State = 271; Match(WHILE);
			State = 272; Match(LPAREN);
			State = 273; if_expression(0);
	...
	public Function_signatureContext function_signature() {
		...
		try {
			...
			case 10:
				...
				{
				State = 347; Match(AVERAGE);
				State = 348; Match(LPAREN);
				State = 349; Match(VAR_PRIMARY);
				State = 350; Match(DOT);
			...
			case 12:
				...
				{
				State = 363; Match(AVERAGE);
				State = 364; Match(LPAREN);
				State = 365; Match(IDENTIFIER);
				State = 366; Match(RPAREN);
				}
				break;
			case 13:
				...
				{
				State = 367; Match(LENGTH);
				State = 368; Match(LPAREN);
				State = 369; Match(VAR_PRIMARY);
				State = 372;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (_la==DOT) {
			...
			case 15:
				...
				{
				State = 379; Match(ROUND);
				State = 380; Match(LPAREN);
				State = 381; arithmetic_expression(0);
				State = 384;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (_la==COMMA) {
					...
					State = 383; arithmetic_expression(0);
					}
				}
			...
			case 17:
				...
				{
				State = 399; Match(SQRT);
				State = 400; Match(LPAREN);
				State = 401; arithmetic_expression(0);
			...
			case 18:
				...
				State = 406; arithmetic_expression(0);
			...
			case 19:
				...
				{
				State = 409; Match(SUM_IF);
				State = 410; Match(LPAREN);
				State = 411; Match(VAR_PRIMARY);
				State = 412; Match(DOT);
			...
			case 20:
				...
				{
				State = 424; Match(SUM_IF);
				State = 425; Match(LPAREN);
				State = 426; Match(IDENTIFIER);
				State = 427; Match(DOT);
				State = 428; Match(IDENTIFIER);
				State = 429; Match(COMMA);
				State = 430; arithmetic_expression(0);
				State = 431; comparison_operator();
				State = 432; arithmetic_expression(0);
			...
			case 21:
				...
				{
				State = 435; Match(COUNT_IF);
				State = 436; Match(LPAREN);
				State = 437; Match(VAR_PRIMARY);
				State = 440;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (_la==DOT) {
			...
			case 22:
				...
				{
				State = 448; Match(COUNT_IF);
				State = 449; Match(LPAREN);
				State = 450; Match(IDENTIFIER);
				State = 451; Match(COMMA);
				State = 452; arithmetic_expression(0);
				State = 453; comparison_operator();
				State = 454; arithmetic_expression(0);
			...
			case 23:
				...
				{
				State = 457; Match(ISNULL);
				State = 458; Match(LPAREN);
				State = 459; arithmetic_expression(0);
			...
			case 24:
				...
				{
				State = 462; Match(DATE_FUNCTION);
				State = 463; Match(LPAREN);
				State = 464; arithmetic_expression(0);
				State = 465; Match(COMMA);
				State = 466; arithmetic_expression(0);
				State = 467; Match(COMMA);
				State = 468; arithmetic_expression(0);
			...
			case 25:
				...
				{
				State = 471; Match(TODAY);
				State = 472; Match(LPAREN);
			...
			case 27:
				...
				{
				State = 477; Match(DATE_DIF);
				State = 478; Match(LPAREN);
				State = 479; arithmetic_expression(0);
				State = 480; Match(COMMA);
				State = 481; arithmetic_expression(0);
			...
			case 28:
				...
				{
				State = 486; Match(GET_YEAR);
				State = 487; Match(LPAREN);
				State = 488; arithmetic_expression(0);
				State = 489; Match(RPAREN);
				}
				break;
			case 29:
			...
			case 31:
				...
				{
				State = 501; Match(GET_HOUR);
				State = 502; Match(LPAREN);
				State = 503; arithmetic_expression(0);
			...
			case 32:
				...
				{
				State = 506; Match(GET_MINUTE);
				State = 507; Match(LPAREN);
				State = 508; arithmetic_expression(0);
			...
			case 33:
				...
				{
				State = 511; Match(ADD_YEAR);
				State = 512; Match(LPAREN);
				State = 513; arithmetic_expression(0);
				State = 514; Match(COMMA);
				State = 515; arithmetic_expression(0);
			...
			case 34:
				...
				{
				State = 518; Match(ADD_MONTH);
				State = 519; Match(LPAREN);
				State = 520; arithmetic_expression(0);
				State = 521; Match(COMMA);
				State = 522; arithmetic_expression(0);
			...
			case 35:
				...
				{
				State = 525; Match(ADD_DAY);
				State = 526; Match(LPAREN);
				State = 527; arithmetic_expression(0);
				State = 528; Match(COMMA);
				State = 529; arithmetic_expression(0);
			...
			case 36:
				...
				{
				State = 532; Match(TRIM);
				State = 533; Match(LPAREN);
				State = 534; arithmetic_expression(0);
				State = 535; Match(RPAREN);
				}
				break;
			}
		}
	...
	private Arithmetic_expressionContext arithmetic_expression(int _p) {
		...
		try {
			...
			case LPAREN:
				...
				State = 541; arithmetic_expression(0);
			...
			while ( _alt!=2 && _alt!=global::Antlr4.Runtime.Atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						State = 549; Match(MULT);
						State = 550; arithmetic_expression(9);
						}
						break;
					case 2:
						{
						...
						if (!(Precpred(Context, 7))) throw new FailedPredicateException(this, "Precpred(Context, 7)");
						State = 552; Match(DIV);
						State = 553; arithmetic_expression(8);
						}
						break;
					case 3:
						{
						...
						State = 554;
						if (!(Precpred(Context, 6))) throw new FailedPredicateException(this, "Precpred(Context, 6)");
						State = 555; Match(PLUS);
						State = 556; arithmetic_expression(7);
						}
						break;
					case 4:
						{
						...
						State = 559; arithmetic_expression(6);
						}
						break;
					case 5:
						{
						...
						State = 561; Match(POW);
						State = 562; arithmetic_expression(5);
						}
						break;
					}
					} 
	...
	public ListMemoryGlobalContext listMemoryGlobal() {
		...
		try {
			...
			EnterOuterAlt(_localctx, 1);
			{
			State = 586; Match(VAR_PRIMARY);
			State = 587; Match(LBRACKET);
			State = 590;
			ErrorHandler.Sync(this);
			switch (TokenStream.LA(1)) {
			case IDENTIFIER:
			...
			case NUMBER:
				{
				State = 589; number_integer();
				}
				break;
			default:
				throw new NoViableAltException(this);
			}
			State = 592; Match(RBRACKET);
			State = 593; Match(DOT);
	...
	public ListMemoryContext listMemory() {
		...
		try {
			...
			case NUMBER:
				{
				State = 601; number_integer();
				}
				break;
			default:
				throw new NoViableAltException(this);
			}
			State = 604; Match(RBRACKET);
			State = 605; Match(DOT);
